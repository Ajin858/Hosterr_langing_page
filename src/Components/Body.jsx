  ...
  return (
    <div className="space-y-4 lg:flex">
      ...
      <div className="lg:flex-1 lg:order-1 space-y-4">
        ...
        <p className="text-lato text-grey-400">
          With Hoster , get your website up and running in no less then 5
          minutes with the most competetive pricing package available online
        </p>
